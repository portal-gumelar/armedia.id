...
function ThankYouContent() {
  ...
  const paketNames: Record<string, string> = {
    ...
    PAKET_2: "PAKET_2 — 30 Mbps (Rp 142.000/bln)",
    PAKET_3: "PAKET_3 — 50 Mbps (Rp 175.000/bln)",
    PAKET_4: "PAKET_4 — 75 Mbps (Rp 250.000/bln)",
    PAKET_5: "PAKET_5 — 100 Mbps (Rp 315.000/bln)",
  };
